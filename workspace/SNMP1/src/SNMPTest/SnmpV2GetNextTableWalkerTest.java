 ...
 *  <pre>
 *  For example:
 *      >java SnmpV2GetNextTableWalkerTest snmphost readcommunity 1.3.6.1.2.1.2.2
 * 
 ...
 *  </pre>
 */
public class SnmpV2GetNextTableWalkerTest
    implements SnmpCustomer
{
     ...
     * Constructor
     */
    public SnmpV2GetNextTableWalkerTest(String szHost, String szReadCommunity, String szLastOID)
    {
        //Sets the initial OID to something which should be before the table
        m_szLastOID = new String[1];
        m_szLastOID[0] = szLastOID;
        m_szStartOID = szLastOID;
        m_iSnmpVarBindsCapacity = 2;
    ...
    public static void main(String[] szArgs)
    {
      if (szArgs.length < 3)
      {
        ...
        try
        {
            ...
            //Creates new walker
            SnmpV2GetNextTableWalkerTest test = new SnmpV2GetNextTableWalkerTest(szHost, szReadCommunity, szTableOID);
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    {
        System.out.println("Usage : java SnmpV2GetNextTableWalkerTest <hostname readcommunity tableOID>");
        System.out.println("\thostname : szHost on which agent resides to walk");
