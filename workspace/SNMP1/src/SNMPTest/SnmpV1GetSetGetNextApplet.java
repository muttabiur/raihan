 ...
 * <pre>
 *   &lt;html>&lt;body>
 *   &lt;applet code="SnmpV1GetSetGetNextApplet" height=400 width=500>
 *   &lt;/applet>
 *   &lt;/body>&lt;/html>
 * </pre>
 * <p>
 ...
 */
public class SnmpV1GetSetGetNextApplet
extends Applet
implements SnmpCustomer, ActionListener, ItemListener
{
     ...
     *
     */
    public SnmpV1GetSetGetNextApplet()
    {
        m_iOrderNumStart = 1;
            ...
            || event.getSource() == m_startSet)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    String szReadCommunity = "";
                    String szWriteCommunity = "";
                    if (event.getSource() == m_startSet)
                    {
                        if (m_writeCommunityField.getText().length() <= 0)
                        {
                        ...
                        szWriteCommunity = m_writeCommunityField.getText();
                        szReadCommunity = "";
                    }
                    ...
                    if (event.getSource() == m_startGet
                        || event.getSource() == m_startGetNext)
                    {
                        if (m_readCommunityField.getText().length() <= 0)
                        {
                        ...
                        szReadCommunity = m_readCommunityField.getText();
                        szWriteCommunity = "";
                    }
