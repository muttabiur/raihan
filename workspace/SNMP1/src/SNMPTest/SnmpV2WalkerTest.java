    ...
    implements SnmpCustomer
{
     ...
     * Constructor
     */
    public SnmpV2WalkerTest(String szHost, String szReadCommunity)
    {
    ...
    public static void main(String[] szArgs)
    {
        ...
        try
        {
            ...
            //Creates new walker
            SnmpV2WalkerTest test = new SnmpV2WalkerTest(szHost, szReadCommunity);
        }
        catch (Exception e)
        {
            e.printStackTrace();
	...
	{
		System.out.println("Usage : java SnmpV2WalkerTest <hostname readcommunity>");
