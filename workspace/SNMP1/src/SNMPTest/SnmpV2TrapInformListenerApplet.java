 ...
 * <pre>
 *   &lt;html>&lt;body>
 *   &lt;applet code="SnmpV2TrapInformListenerApplet" height=400 width=500>
 *   &lt;/applet>
 *   &lt;/body>&lt;/html>
 * </pre>
 * <p>
 ...
 */
public class SnmpV2TrapInformListenerApplet
extends Applet
implements SnmpTrapListener, ActionListener
{
    ...
    private SnmpTrapProfile                         m_trapInformProfile;
     ...
     *
     */
    public SnmpV2TrapInformListenerApplet()
    {
    }
        ...
        throws Exception
    {
        ...
        m_trapInformProfile = SnmpLocalInterfaces.getTrapProfileFactory().createSnmpTrapProfile(162);
    ...
    {
        if (event.getSource() == m_addTrapHost)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (!m_trapInformProfile.addTrapSession(m_cSnmpRemoteAuthoritativeSession))
                    {
        ...
        else if (event.getSource() == m_removeTrapHost)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (m_trapInformProfile.removeTrapSession(m_cSnmpRemoteAuthoritativeSession))
                    {
                        m_removeTrapHost.setEnabled(false);
                        m_listTrapHosts.setEnabled(false);
                    }
        ...
        else if (event.getSource() == m_addInformHost)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    SnmpAuthoritativeSessionFactory cSnmpAuthoritativeSessionFactory = SnmpLocalInterfaces.getAuthoritativeSessionFactory();
                    m_cSnmpLocalAuthoritativeSession = cSnmpAuthoritativeSessionFactory.createLocalAuthoritativeSession(m_szInformHost,
                                                                                                           162,
                                                                                                           SnmpConstants.SNMP_VERSION_2,
                                                                                                           secInfo);
            
                    if (!m_trapInformProfile.addInformSession(m_cSnmpLocalAuthoritativeSession))
                    {
        ...
        else if (event.getSource() == m_removeInformHost)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (m_trapInformProfile.removeInformSession(m_cSnmpLocalAuthoritativeSession))
                    {
                        m_removeInformHost.setEnabled(false);
                        m_listInformHosts.setEnabled(false);
                    }
