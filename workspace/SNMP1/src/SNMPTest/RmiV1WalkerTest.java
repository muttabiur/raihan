    ...
    implements SnmpCustomer
{
     ...
     * Constructor
     */
    public RmiV1WalkerTest(String szRmiHost, String szHost, String szReadCommunity)
    {
    ...
    public static void main(String[] szArgs)
    {
        ...
        try
        {
            ...
            //Creates new walker
            RmiV1WalkerTest cRmiV1WalkerTest = new RmiV1WalkerTest(szRmiHost, szHost, szReadCommunity);
    ...
    {
        System.out.println("Usage : java RmiV1WalkerTest <rmihostname hostname readcommunity>");
