 ...
 */
public class RmiV2TrapInformSenderApplet
    extends Applet
    implements SnmpCustomer, ActionListener, ItemListener
{
    ...
    private SnmpAuthoritativeSession                m_localSession;
    private SnmpAuthoritativeSession                m_remoteSession;
     ...
     *
     */
    public RmiV2TrapInformSenderApplet()
    {
            ...
            || event.getSource() == m_startSendInform)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    // trap session
                    m_localSession = m_sessionFactory.createLocalAuthoritativeSession(m_szManagedHost,
                                                                                      162,
                                                                                      SnmpConstants.SNMP_VERSION_2,
                                                                                      secInfo);
                    // inform session
                    m_remoteSession = m_sessionFactory.createRemoteAuthoritativeSession(m_szManagedHost,
                                                                                        162,
                                                                                        SnmpConstants.SNMP_VERSION_2,
                                                                                        secInfo);
                    ...
                    if (event.getSource() == m_startSendTrap)
                    {
                        boolean bVal = m_service.placeTrapOrder(m_localSession,
                    ...
                    {
                        int iVal = m_service.placeInformOrder(m_remoteSession,
                                                              m_orderinfo,
                                                              m_trapOIDField.getText(),
                                                              new Integer(m_trapNumField.getText()).intValue(),
                                                              szVarbindOIDs,
