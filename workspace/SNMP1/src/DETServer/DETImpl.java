...
class DETImpl extends DETPOA 
{
	     ...
	     */
		  ...
		  // public static final String item1 = "Computer";
		   ...
		   public static final String item1 = "Shoe";
		   
		   public static final String item2 = "Computer";
		   ...
		   public static final double BALANCE = 3000;
	...
	public int printReport()
	{
		...
		System.out.println("Item_Name \t Quantity \t Price \t ServerName");
				   ...
				   synchronized(lockItm){
					   ...
					   if (itm.getQty()>=q)  // have quanity to sell
						{					
							...
							//System.our.println( itm.getBalance())
      ...
      //Create a DataGram Socket object and initialize to null .
		...
		public  void run(){
			try{
				...
				newSocket = new DatagramSocket(6780);
