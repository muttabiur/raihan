...
/**
* OcsSNMPv1/ASNTypeHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from OcsSNMPv1.idl
* Monday, January 26, 2009 4:24:09 o'clock PM EST
*/

abstract public class ASNTypeHelper
{
  private static String  _id = "IDL:OcsSNMPv1/ASNType:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (OcsSNMPv1.ASNTypeHelper.id (), "ASNType", __typeCode);
    }
    return __typeCode;
  }
