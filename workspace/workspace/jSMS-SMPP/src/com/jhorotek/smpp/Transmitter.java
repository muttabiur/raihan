...
//import com.logica.smpp.test.SMPPTest.SMPPTestPDUEventListener;
...
public class Transmitter{
    ...
    /**
     * address for sending msg to SMSC.
     */
	 ...
	 * constructor
	 */
	public Transmitter(XMLConfiguration conf, boolean debuglog) {
		config = conf;
		name = config.getString("NAME");
		debug = new FileDebug(dbgDir, name+"_transmit.dbg");
		event = new FileEvent(dbgDir, name+"_transmit.evt");
    ...
    {
    	System.out.println("In Transmitter bind....");
    ...
    public synchronized boolean submit(SubmitSM request)
    {
        ...
        try {
          ...
          //Set to NULL for default SMSC settings.
            ...
            //Comes with preSet from pushpull / pull system for more convenience 
