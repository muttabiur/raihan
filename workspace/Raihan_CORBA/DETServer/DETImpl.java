...
class DETImpl extends DETPOA 
{
	     ...
	     */
		   ...
		   public static final String NamingObj = "DETSHOE";
		   
		   public static final String NamingObj1 = "DETSHOE";
		   
		  // public static final String NamingServer = "localhost";
		   public static final String NamingObj2 = "DETCOMPUTER";
		   ...
		   public static final String ITEM = "Shoe";
		   ...
		   /*
		    * This following Information represents about the Server internal information 
		    */
		   
		   public static final String SYSTEM_DESCRIPTION = " It is CISCO Server";
		   public static final String SYSTEM_CONTACT = " 3045 ST-Marc, Silicon Vally, CA, USA";
		   public static final String SYSTEM_NAME = "CISCO Process Management System ";
		   public static final String SYSTEM_LOCATION ="Toronto, ON CANADA" ;
		   public static final String SYSTEM_SERVICE = "NoSuchName" ;
	...
	public int SnmpSetBalance()  {
		...
		// if balance is 0 then sends message to the agent
		double bal = itm.getBalance();
		if ((bal == 0) ||(bal < 0))
		{
		   itm.setBalance(6000.00);
		}
	   }
	       Manager m = new Manager();
	       m.MessagePassed("The Balance Set up is done Sucessfully:");
	       
	       double b = 0.0 ;
	       b = itm.getBalance();
	       System.out.println("###################### NEW BALANCE IS UPDATED ##############");
	       System.out.println("It is just a test that balance has change:" + b);
	       System.out.println("###################### NEW BALANCE IS UPDATED ##############");
	       return 1 ;
	}
	public int printReportAfterTransaction()
	{
	    Manager m = new Manager();
			...
			if ((bal == 0) ||(bal < 0))
			{
			    m.snmpTrapMessageReceived(0.0);
			   // m.snmpSetRequest(6500);
			    //String raihan =  m.snmpSetRequest(6500);
				   // String raihan = detImpl.snmpSetRequest(6000);
				   // Agent_Shoe sh = new Agent_Shoe();
				    //sh.ResponseSet(raihan);
			}
			System.out.println("");
			System.out.println("The Current Information about ServerShoe After Some transactions Happened!");
			System.out.println("DETSHOE Server's Initial: " + "BalanceInfo:" + "" + " QuantityInfo:" + ""+ " PriceInfo:"+"" + " ManagedItemInfo:");
			System.out.println("");
			System.out.println("*************************  Distributed E-Trader REPORT **************************");
			System.out.println("===========================================================================");
			System.out.println("ITEM_NAME: "+ itm.name +"    QUANTITY:"+ itm.getQty() + "    PRICE : " + pr + "    BALANCE: "+ bl);
	...
	/*
	public String snmpSetRequest(double bal) {
	     synchronized(lockItm) {
		    itm.setBalance(bal);
		    String ok = null;
		    return ok ;
 ...
 public boolean snmpSentRequestToServer1( String item1) {
	 ...
	 try {
		 ...
		 String ser=(String)servers.get(item1); // find server deal with this item
		...
		//String arg1[]={"-ORBInitialHost", detImpl.NamingServer ,"-ORBInitialPort", "1234"};
         ...
         detImpl = DETHelper.narrow(ncRef.resolve_str(ser));
        ...
        // return res;
          ...
          System.out.println("Call Server Error Happens!: " +  "   "  + e);
 ...
 public boolean snmpSentRequestToServer2( String item2) {
	 ...
	 try {
		 ...
		 String ser=(String)servers.get(item2); // find server deal with this item
 ...
 public int getPrintReportFromServer1() {
	 ...
	 System.out.println("=========================================================");
	 System.out.println("Server reply to the Manager:");
	 System.out.println("GetPrintReport displays the entire transcation History:");
	 System.out.println("==========================================================");
	 System.out.println("");
...
public String snmpGetRequestSysDescription( String item2) {
	 ...
	 try {
		...
		//String arg1[]={"-ORBInitialHost", detImpl.NamingServer ,"-ORBInitialPort", "1234"};
         ...
         SystemDescription = DETImpl.SYSTEM_DESCRIPTION ;
...
public String snmpGetRequestSysContact(String item2) {
	 ...
	 try {
        ...
        SystemContact = DETImpl.SYSTEM_CONTACT ;
...
public String snmpGetRequestSysName(String item2) {
	 ...
	 try {
       ...
       SystemName = DETImpl.SYSTEM_NAME ;
...
public String snmpGetRequestSysLocation(String item2) {
	 ...
	 try {
      ...
      SystemLocation = DETImpl.SYSTEM_LOCATION ;
...
public String snmpGetRequestSysServiceInfo(String item2) {
     ...
     SystemService = DETImpl.SYSTEM_SERVICE ;
