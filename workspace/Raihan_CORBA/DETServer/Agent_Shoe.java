...
public class Agent_Shoe {

    static DET detImpl;
    public void monitorDetShoeServerBeforeTransaction() {
	
	System.out.println("The Current Information about ServerShoe befor any transaction Happens!");
	...
	String mValue = null ;
	System.out.println("");
	System.out.println("Testing DETSHOE Server's Price information:");
	...
	//System.out.println("");
	//System.out.println("Testing DETSHOE Server's Quantity information:");
	...
	String mValue2 = null ;
	System.out.println("");
	System.out.println("Testing DETSHOE Server's Balance information:");
	...
	System.out.println("Testing DETSHOE Server's Balance information:");
	System.out.println("");
	so.searchObject("balance:");
	*/
    }
    
    
    public void monitorDetShoeServerAfterTransaction() {
   ...
   try{	
	  ...
	  // All of the thread will be stored in the thread queue.
		...
		{		
	 	...
	 	Agent_Shoe agent = new Agent_Shoe();
                ...
                agent.monitorDetShoeServerBeforeTransaction();
		
		System.out.println("");
	 	agent.monitorDetShoeServerAfterTransaction() ;
    ...
    public void trapResponse(String trap) {
    ...
    public void ResponseSet(String tra) {
	      ...
	      System.out.println("");
	      System.out.println("################################################## BALANCE SET-UP MESSAGE FROM MANAGER #################################################");
	      System.out.println("The Received Message from the Manager:" + tp);
              System.out.println("################################################## BALANCE SET-UP MESSAGE FROM MANAGER ##################################################");
	      System.out.println("");
	      
	  }
    //This following function is used for test purpose
    /*
 public static void main(String args[]) {
