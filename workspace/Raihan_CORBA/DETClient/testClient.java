...
public class testClient {
	...
	// Initialization of three different items
       ...
       try{	
	    ...
	    String SystemDes ;
	    SystemDes = detImpl.snmpGetRequestSysDescription(itm2);
	    ...
	    SystemCont = detImpl.snmpGetRequestSysContact(itm2);
	    ...
	    SystemName = detImpl.snmpGetRequestSysName(itm2);
	    
	    System.out.println("The SystemName Information is Stated Below:" + SystemName);
	    ...
	    SystemLocation = detImpl.snmpGetRequestSysLocation(itm2);
	    ...
	    SystemService = detImpl.snmpGetRequestSysServiceInfo(itm2);
