/* $Id: count_async_gets.src,v 1.4.2.5 2006/07/07 15:01:30 rravikumar Exp $ */
/*
 ...
 * 
 * v3 request:
 * java count_async_gets [-d] [-v version(v1,v2,v3)] [-c community] [-p port] -m [MIB_files] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-n contextName] [-i contextID] host OID [OID] ...
 * e.g.
...
public class count_async_gets implements SnmpClient 
{
    public static void main(String args[]) 
    {
        ...
        String usage = 
            ...
            "[-i contextID][-pp privProtocol (AES/DES)] host OID [OID] ...";
