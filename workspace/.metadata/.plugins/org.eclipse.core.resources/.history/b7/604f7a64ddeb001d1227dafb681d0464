/*$Id: getSnmpAugmentTable.src,v 1.1.2.1 2006/08/30 13:01:02 kcpravin Exp $*/
/*
...
public class getSnmpAugmentTable implements SnmpTableListener {
    ...
    String usage = "getSnmpAugmentTable [-v version(v1,v2,v3)] [-c community] [-p port] [-t timeout] [-r retries] [-u user] [-a auth_protocol(MD5/SHA)] [-w auth_password] [-s priv_password] [-n contextname] [-i contextID] [-d debug] [ -pp priv_protocol (DES/AES) ] host tableOID MIB_files";
