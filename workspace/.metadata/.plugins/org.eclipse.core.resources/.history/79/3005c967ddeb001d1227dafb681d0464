/* $Id: snmpset.src,v 1.4.2.3 2006/07/10 16:31:17 rravikumar Exp $ */
/*
 * @(#)snmpset.java
 ...
 * 
 * v3 request:
 * java snmpset [-d] [-v version(v1,v2,v3)] [-c community] [-p port] [-r retries] [-t timeout] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-i context_id] host [OID {INTEGER | STRING | GAUGE | TIMETICKS | OPAQUE | IPADDRESS | COUNTER | OID } value] ...
 * e.g.
...
public class snmpset {
    ...
    public static void main(String args[]) {        
        ...
        String usage = "snmpset [-d] [-v version(v1,v2,v3)] [-c community] [-wc writeCommunity] [-p port] [-r retries] [-t timeout] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-n contextName] [-i contextID][-pp privProtocol (AES/DES)] host [OID {INTEGER | STRING | GAUGE | TIMETICKS | OPAQUE | IPADDRESS | COUNTER | OID } value] ...";
