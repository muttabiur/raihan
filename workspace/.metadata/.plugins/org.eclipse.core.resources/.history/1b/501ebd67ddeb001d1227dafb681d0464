/* $Id: snmpgetnext.src,v 1.4.2.3 2006/07/10 16:30:51 rravikumar Exp $ */
/*
 * @(#)snmpgetnext.java
 ...
 * 
 * v3 request:
 * java snmpgetnext [-d] [-v version(v1,v2,v3)] [-c community] [-p port] [-r retries] [-t timeout] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-i context_id] host OID [OID] ...
 * e.g.
...
public class snmpgetnext {
    ...
    public static void main(String args[]) {
        ...
        String usage = "snmpgetnext [-d] [-v version(v1,v2,v3)] [-c community] [-p port] [-r retries] [-t timeout] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-n contextName] [-i contextID] [-pp privProtocol (AES/DES)] host OID [OID] ...";
