/*$Id: getRow.src,v 1.3.2.3 2006/07/10 06:43:13 srikrishnan Exp $*/
/*
 * @(#)getRow.java
...
public class getRow {
    ...
    String usage = "getRow [-v version(v1,v2,v3)] [-c community] [-p port] [-t timeout] [-r retries] [-u user] [-a auth_protocol(MD5/SHA)] [-w auth_password] [-s priv_password] [-n contextname] [-i contextID] [-d debug] [ -pp priv_protocol (DES/AES) ] host tableOID MIB_files rowIndex";
