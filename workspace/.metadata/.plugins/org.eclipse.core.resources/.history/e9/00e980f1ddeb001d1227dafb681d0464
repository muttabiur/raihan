/* $Id: snmpwalk.src,v 1.4.2.5 2006/07/07 14:59:11 rravikumar Exp $ */
/*
 * @(#)snmpwalk.java
 ...
 * 
 * v3 request:
 * java snmpwalk [-d] [-v version(v1,v2,v3)] [-c community] [-p port] [-r retries] [-t timeout] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-n contextName] [-i contextID] host OID
 * e.g.
...
public class snmpwalk 
{
    ...
    public static void main(String args[]) 
    {
        ...
        String usage = 
            ...
            "[-s priv_password] [-n contextName] [-i contextID][-pp privProtocol (AES/DES)] host OID ";
